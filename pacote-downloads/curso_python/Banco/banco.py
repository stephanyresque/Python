...
if __name__ == '__main__':
    c1 = pessoas.Cliente('Stephany Resque', 20)
    cc1 = contas.ContaCorrente(777, 444, 0, 0)
    c1.conta = cc1
    c2 = pessoas.Cliente('Nathalia Moreno', 20)
    cp2= contas.ContaPoupanca(888, 333, 100)
    c2.conta = cp2
    banco = Banco()
    banco.clientes.extend([c1, c2])
    banco.contas.extend([cc1, cp2])
    banco.agencias.extend([777,444])
